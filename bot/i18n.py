...
TEXTS = {
    ...
    "uz": {
        ...
        "book_gone": "Bu kitobni topa olmadim. Botda qidirib ko‘ring.",
    ...
    "ru": {
        ...
        "book_gone": "Не нашёл эту книгу. Попробуйте найти её в боте.",
    ...
    "ar": {
        ...
        "book_gone": "لم أجد هذا الكتاب. جرّب البحث عنه في البوت.",
...
# Проверено на выдаче Internet Archive: длинные фразы там склеиваются через AND
# по всему тексту и дают ноль («hadis to'plami», «сира пророк Мухаммад история» —
# 0 результатов), поэтому оставлены короткие слова, реально встречающиеся
# в названиях книг. Для латиницы — международные транслитерации: узбекских
